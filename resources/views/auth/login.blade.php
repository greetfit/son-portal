    ...
    <div class="col-xl-5">
        ...
        <div class="card auth-card">
            <div class="card-body px-3 py-5">
                ...
                <p class="text-muted text-center mt-1 mb-4">Enter your email address and password to access <br>Shadow of Nature (Pvt) ltd Portal </p>
                ...
                <div class="px-4">
                    <form method="POST" action="{{ route('login') }}" class="authentication-form">
                        ...
                        <div class="mb-1 text-center d-grid">
                            <button class="btn btn-success py-2 fw-medium" type="submit">Sign In</button>
                        </div>
                    </form>
