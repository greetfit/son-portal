        ...
        <ul class="navbar-nav" id="navbar-nav">
                ...
                <div class="collapse" id="sidebarDashboards">
                    <ul class="nav sub-navbar-nav">
                        @if (auth()->user()->hasRole('super_admin'))
                            <li class="sub-nav-item">
                                <a class="sub-nav-link"
                                    href="{{ route('second', ['dashboards', 'analytics']) }}">Analytics</a>
                            </li>
                            <li class="sub-nav-item">
                        ...
                        @elseif(auth()->user()->hasRole('user'))
                            <li class="sub-nav-item">
                                <a class="sub-nav-link"
                                    href="{{ route('second', ['dashboards', 'customer']) }}">Customer</a>
                            </li>
                        @endif
                    </ul>
                </div>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarProperty">
                    <ul class="nav sub-navbar-nav">
                        ...
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['property', 'details']) }}">Property
                                Details</a>
                        </li>
                        <li class="sub-nav-item">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarAgents">
                    <ul class="nav sub-navbar-nav">
                        ...
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['agents', 'details']) }}">Agent
                                Details</a>
                        </li>
                        <li class="sub-nav-item">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarCustomers">
                    <ul class="nav sub-navbar-nav">
                        ...
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['customers', 'details']) }}">Customer
                                Details</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['customers', 'add']) }}">Add
                                Customer</a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarBlog">
                    <ul class="nav sub-navbar-nav">
                        ...
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['post', 'details']) }}">Post
                                Details</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['post', 'create-post']) }}">Create
                                Post</a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarPages">
                    <ul class="nav sub-navbar-nav">
                        ...
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['pages', 'coming-soon']) }}">Coming
                                Soon</a>
                        </li>
                        <li class="sub-nav-item">
                        ...
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('second', ['pages', 'maintenance']) }}">Maintenance</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['pages', 'error-404']) }}">404
                                Error</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['pages', 'error-404-alt']) }}">404
                                Error (alt)</a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarAuthentication">
                    <ul class="nav sub-navbar-nav">
                        ...
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['auth', 'password']) }}">Reset
                                Password</a>
                        </li>
                        <li class="sub-nav-item">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarLayouts">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['layouts-eg', 'dark-sidenav']) }}"
                                target="_blank">Dark Sidenav</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['layouts-eg', 'dark-topnav']) }}"
                                target="_blank">Dark Topnav</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['layouts-eg', 'simple-sidenav']) }}"
                                target="_blank">Simple Sidenav</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['layouts-eg', 'small-sidenav']) }}"
                                target="_blank">Small Sidenav</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['layouts-eg', 'small-hover']) }}"
                                target="_blank">Small Hover</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('second', ['layouts-eg', 'small-hover-active']) }}"
                                target="_blank">Small Hover Active</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['layouts-eg', 'hidden-sidenav']) }}"
                                target="_blank">Hidden Sidenav</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" target="_blank"
                                href="{{ route('second', ['layouts-eg', 'layout-dark']) }}">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarBaseUI">
                    <ul class="nav sub-navbar-nav">
                        ...
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('second', ['ui', 'placeholders']) }}">Placeholders</a>
                        </li>
                        <li class="sub-nav-item">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarUserManagement">
                    <ul class="nav sub-navbar-nav">
                        ...
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['extended', 'sweetalerts']) }}">Sweet
                                Alert</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('second', ['extended', 'swiper-slider']) }}">Swiper Slider</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('second', ['extended', 'scrollbar']) }}">Scrollbar</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('second', ['extended', 'toastify']) }}">Toastify</a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarCharts">
                    <ul class="nav sub-navbar-nav">
                        ...
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['charts', 'apex-polar-area']) }}">Polar
                                Area</a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarForms">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['forms', 'basic']) }}">Basic
                                Elements</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('second', ['forms', 'checkbox-radio']) }}">Checkbox &amp; Radio</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['forms', 'choice']) }}">Choice
                                Select</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('second', ['forms', 'clipboard']) }}">Clipboard</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('second', ['forms', 'flatepicker']) }}">Flatepicker</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                        ...
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['forms', 'fileuploads']) }}">File
                                Upload</a>
                        </li>
                        <li class="sub-nav-item">
                        ...
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['forms', 'input-mask']) }}">Input
                                Mask</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('second', ['forms', 'range-slider']) }}">Slider</a>
                        </li>
                    </ul>
                </div>
            </li> <!-- end Form Menu -->
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarTables">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['tables', 'basic']) }}">Basic
                                Tables</a>
                        </li>
                        <li class="sub-nav-item">
            ...
            @if (auth()->user()->hasRole('super_admin'))
                <li class="nav-item">
                    <a class="nav-link menu-arrow" href="#sidebarHotels" data-bs-toggle="collapse" role="button"
                        aria-expanded="false" aria-controls="sidebarHotels">
                        <span class="nav-icon"><i class="ri-hotel-fill"></i></span>
                        <span class="nav-text">Property</span>
                    </a>
                    <div class="collapse" id="sidebarHotels">
                        <ul class="nav sub-navbar-nav">
                            <li class="sub-nav-item">
                                <a class="sub-nav-link" href="{{ route('hotels.index') }}">Hotels</a>
                            </li>
                            <li class="sub-nav-item">
                                <a class="sub-nav-link" href="{{ route('hotels.create') }}">Create Hotels</a>
                            </li>
                            <li class="sub-nav-item">
                                <a class="sub-nav-link" href="">Rooms</a>
                            </li>
                            <li class="sub-nav-item">
                                <a class="sub-nav-link" href=" ">Room Types</a>
                            </li>
                            <li class="sub-nav-item">
                                <a class="sub-nav-link" href=" ">Meal Plans</a>
                            </li>
                            <li class="sub-nav-item">
                                <a class="sub-nav-link" href="">Amenities</a>
                            </li>
                            <li class="sub-nav-item">
            ...
            @if (auth()->user()->hasRole('super_admin'))
                <li class="nav-item">
                    <a class="nav-link menu-arrow" href="#sidebarExtendedUI" data-bs-toggle="collapse"
                        ...
                        <span class="nav-icon"><i class="ri-group-fill"></i></span>
                        <span class="nav-text">User Management</span>
                    </a>
                    <div class="collapse" id="sidebarExtendedUI">
                        <ul class="nav sub-navbar-nav">
                            <li class="sub-nav-item">
                                <a class="sub-nav-link" href="{{ route('users.index') }}">All Users</a>
                            </li>
                            <li class="sub-nav-item">
